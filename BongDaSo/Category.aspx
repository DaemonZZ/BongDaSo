<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Category.aspx.cs" Inherits="BongDaSo.Category" %>
            ...
            <div class="col-lg-8 col-md-8 col-sm-8">
                <div class="left_content">
                    <div class="single_page">
                        ...
                        <asp:DataList ID="DataList1" runat="server" DataKeyField="id" RepeatColumns="1" RepeatLayout="Flow">
                            <ItemTemplate>
                                <div>
                                    <table style="width: 705px">
                                        <tr>
                                            <td rowspan="2" style="width: 99px">
                                                <asp:Image ID="imgCover" runat="server" ImageUrl='<%# Eval("cover", "{0}") %>' Width="150px" /></td>
                                            <td style="height: 100%; width: 100%; padding-left: 20px; vertical-align: top">
                                                <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Italic="True" Font-Size="12pt" NavigateUrl='<%# Eval("id", "Desc.aspx?ID={0}") %>' Text='<%# Eval("title", "{0}") %>'></asp:HyperLink></td>
                                        </tr>
                                        <tr>
                                            <td style="height: 100%; width: 100%; padding-left: 20px; vertical-align: text-top">
                                                <asp:Label ID="lbTomtat" runat="server" Text='<%# Eval("tomTat", "{0}") %>'></asp:Label></td>
                                        </tr>
                                    </table>
                                </div>
                            </ItemTemplate>
                        ...
                        <asp:Repeater ID="rpPaging" runat="server" OnItemDataBound="rpPaging_ItemDataBound">
                            <ItemTemplate>
                                <asp:LinkButton ID="btnPage"
                                    Style="padding: 1px 3px; margin: 1px; border: solid 1px #666; font: 8pt tahoma;"
                                    runat="server">
                                </asp:LinkButton>
                            </ItemTemplate>
                        </asp:Repeater>
